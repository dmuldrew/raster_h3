...
*(Note: `h3_polygon_wkt_to_cells` indexes hexagons whose centroids fall within the polygon boundary. Choose a resolution fine enough—such as Res 8 or 9 for tracts—so boundaries contain multiple cell centers).*
