...
use crate::ffi::{ffi_bind_guard, ffi_init_guard, ffi_scan_guard, get_vector_size, to_c_string};
        ...
        match global_data.format {
            ...
            CategoricalOutputFormat::Long => {
                ...
                let rows = {
                    ...
                    while long_queue.len() < vector_size * 4 {
                    ...
                    let num_taken = vector_size.min(long_queue.len());
